...
import er505 from './assets/505-error.png'
const Error500 =()=>{
					...
					<div className="row g-0">
						<div className="col-xl-5">
							<div className="card-body p-4">
								<h1 className="display-1"><span className="text-warning">5</span><span className="text-danger">0</span><span className="text-primary">0</span></h1>
								...
								<div className="mt-5">	<a    className="btn btn-lg btn-primary px-md-5 radius-30">Go Home</a>
									<a    className="btn btn-lg btn-outline-dark ms-3 px-md-5 radius-30">Back</a>
								</div>
							</div>
						</div>
						<div className="col-xl-7">
							<img src={er505} className="img-fluid" alt=""/>
						</div>
					</div>
